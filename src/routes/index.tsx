...
const workflowCards = [
  ...
  },
  {
    ...
    copy: "Every uploaded PDF has a moderation lane before it becomes visible to the wider cohort.",
  },
  {
  ...
  return (
    <main className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.04] shadow-[0_40px_120px_rgba(0,0,0,0.35)] backdrop-blur-sm">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="p-6 sm:p-8 lg:p-10">
              <div className="flex flex-col gap-6">
                ...
                <div className="space-y-5 pt-8">
                  <span className="inline-flex rounded-full border border-orange-300/15 bg-orange-500/10 px-4 py-2 font-mono text-[0.72rem] uppercase tracking-[0.3em] text-orange-200/80">
                    LMS Reading Room
                  </span>

                  <div className="space-y-4">
                    <h1 className="text-balance max-w-4xl text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl">
                      Moderated student access, curated PDFs, and a cleaner LMS library surface.
                    </h1>
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    <Link
                      className="rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-stone-950 transition hover:bg-orange-50"
                      to="/students/sign-up"
                    >
            ...
            <div className="relative min-h-[26rem] overflow-hidden border-t border-white/10 lg:border-t-0 lg:border-l">
              ...
              <div className="absolute left-8 top-8 h-56 w-56 rounded-full bg-black/28 blur-3xl" />
              <div className="absolute -bottom-10 right-8 h-72 w-72 rounded-full bg-orange-200/10 blur-3xl" />

              <div className="relative z-10 flex h-full flex-col justify-between p-8 sm:p-10">
                <div className="flex justify-end">
                  <span className="rounded-full border border-white/12 bg-black/12 px-4 py-2 font-mono text-[0.68rem] uppercase tracking-[0.3em] text-orange-50/75">
                    Guided Access
                  </span>
                </div>
                ...
                <div className="mx-auto flex w-full max-w-sm items-center justify-center">
                  <div className="relative h-[24rem] w-[18rem]">
                    ...
                    <div className="relative mx-auto flex h-[20rem] w-[16rem] items-end justify-center rounded-[2.2rem] border border-white/15 bg-slate-900/80 p-5 shadow-[0_35px_110px_rgba(0,0,0,0.45)]">
                      <div className="flex h-52 w-44 flex-col rounded-[1.3rem] border border-stone-700/70 bg-[#1b1d24] p-4">
                        <div className="rounded-[1rem] border border-stone-700 bg-[#efd07d] px-4 py-5 text-stone-900">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.28)] backdrop-blur-sm sm:p-8">
            <p className="font-mono text-[0.68rem] uppercase tracking-[0.32em] text-orange-200/70">
              Core workflow
            </p>
